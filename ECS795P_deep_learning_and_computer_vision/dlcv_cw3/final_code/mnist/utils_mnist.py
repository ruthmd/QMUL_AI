...
def train(net, trainloader, testloader, epoches, optimizer , criterion, scheduler=None):
    ...
    for i in range(epoches):
        ...
        if testloader is not None:
            ...
            print(f'Epoch [{i + 1:>3d}/{epoches:>3d}] | Train Loss:{train_loss:>.6f} | Train Acc:{train_acc:>3.2f}% | Test Loss:{test_loss:>.6f} | Test Acc:{test_acc:>3.2f}% | Learning Rate:{lr:>.6f} | Time: {time_str}')
